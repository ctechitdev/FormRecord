...
<a href="nav.php"><img src="kplogo.png" alt="Hot Air Balloons" width="70" height="70"></a>
        ...
        <div>
            ...
            ?>
                ...
                <p style="color: darkblue;" >Shell product: Draft Order Records</p> 
        <form action="otorderdetails_view.php" method="post">
      ...
      <!-- populate table from mysql database -->
				...
				$data = mysqli_query($conn,"  SELECT * FROM otorderdetails where  entry_date like '%$valueToSearch%' or  salesperson like '%$valueToSearch%' or  customername like '%$valueToSearch%'  "); 
				while($row = mysqli_fetch_array($data)){?>
                <tr class="mysize h-25" style="font-size:12px;" >
